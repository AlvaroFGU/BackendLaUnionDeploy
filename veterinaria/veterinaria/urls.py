...
urlpatterns = [
    ...
    path('api/cliente/<int:id_usuario>/editar/', editar_cliente, name='editar_cliente'),
    ...
    path('api/cita/', listar_citas, name='listado_citas'),
    ...
    path('api/veterinario/', listar_veterinarios, name='listar_veterinarios'),
    path('api/horarios-libres/', listar_horarios_libres, name='listar_horarios_libres'),

    path('api/lista_cita/', listar_citas, name='listar_citas'),
    path('api/citacion/crear/', crear_cita, name='crear_cita'),
    path('api/cita/<int:pk>/cancelar/', cancelar_cita, name='cancelar_cita'),
    path('api/cita/<int:pk>/confirmar/', programar_cita, name='programar_cita'),
    path('api/cita/<int:pk>/eliminar/', eliminar_cita, name='eliminar_cita'),
    path('api/cita/<int:pk>/asistir/', asistir_cita, name='asistir_cita'),
    path('api/consulta/crear/', crear_consulta, name='crear_consulta'),

    path('api/consulta/', listar_consultas, name='listar_consultas'),
    path('api/consultas/mascota/<int:id_mascota>/', listar_consultas_por_mascota, name='listar_consultas_mascota'),
    path('api/consultas/veterinario/<int:id_veterinario>/', listar_consultas_por_veterinario, name='listar_consultas_veterinario'),
    path('api/consultas/detalle/<int:id_composicion>/', listar_consulta_por_id, name='listar_consultas_id'),

    path('api/accion_tratamiento/', listar_accion_tratamientos, name='listar_accion_tratamiento'),
    path('api/especie/', listar_especies, name='listar_especies'),
    path("api/tratamiento/<int:id_tratamiento>/pago/", actualizar_pago_tratamiento, name="tratamiento-actualizar-pago"),
    path("api/tratamiento/<int:id_tratamiento>/estado/", actualizar_estado_tratamiento, name="tratamiento-actualizar-estado"),
    path("api/exportar_historial/<int:id_mascota>/", exportar_datos_historial, name="exportar_historial"),
    path('api/importar_historial/', importar_historial, name='importar_historial'),
